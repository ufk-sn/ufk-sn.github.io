...
function init(){
	...
	farmer = new Passenger(textures['../images/kurt/farmer.png'],w2,h2,'farmer',0,true);
	
	wolf = new Passenger(textures['../images/kurt/wolf.png'],w2,h2,'wolf',1);
	
	goat = new Passenger(textures['../images/kurt/goat.png'],w2,h2,'goat',2);
	
	cabbage = new Passenger(textures['../images/kurt/cabbage.png'],w2,h2,'cabbage',3);

	boat = new Boat(textures['../images/kurt/boat.png']); 
...
function loadImages(){
	let total = 0;
	imgSrc = ['../images/kurt/farmer.png','../images/kurt/wolf.png','../images/kurt/goat.png','../images/kurt/cabbage.png','../images/kurt/boat.png'];
	textures = {};
	for(name of imgSrc){
